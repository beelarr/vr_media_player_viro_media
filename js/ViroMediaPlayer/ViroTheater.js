...
var ViroTheater = createReactClass({
    ...
    _onVideoTapped ()  {
        var videoControlAnimationState = this.state.videoControlsAnimation;
        if (videoControlAnimationState=="fadeIn") {
            videoControlAnimationState="fadeOut"
        }else {
            videoControlAnimationState="fadeIn";
        }

        this.setState({
            videoControlsAnimation:videoControlAnimationState,
            runAnimation:true,
        });
    },
        ...
        return (
            ...
            >
                ...
                <ViroButton
                    ...
                    tapSouce={require('./res/icon_360_hover.png')}
